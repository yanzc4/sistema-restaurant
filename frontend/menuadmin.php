<nav class="sidebar close">
    ...
    <div class="menu-bar">
        <div class="menu">
            ...
            <ul class="menu-links">
                <li class="nav-link">
                    <a href="view/dashboard.php" target="myFrame">
                ...
                <li class="nav-link">
                    <a href="view/reportes.php" target="myFrame">
                ...
                <li class="nav-link">
                    <a href="view/ajustes.php" target="myFrame">
                ...
                <li class="nav-link">
                    <a href="view/inventario.php" target="myFrame">
